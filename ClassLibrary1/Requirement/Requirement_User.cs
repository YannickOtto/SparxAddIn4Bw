...
namespace Requirements
{
    public class Requirement_User : Requirement
    {
        ...
        public Requirement_User(string Titel, string Text, string W_OBJECT, string W_PROZESSWORT, string QUALITÄT, string RANDBEDINGUNG, bool W_SINGULAR, string W_SUBJECT, bool W_zu, string w_NUTZENDER, string recent_GUID, Metamodels.Metamodel metamodel) : base(recent_GUID, metamodel)
        {
            ...
            this.W_AKTIVITAET = W_AKTIVITAET.dieMöglichkeitbieten; 
            this.W_ZU = W_zu;
        ...
        public string Create_Requirement_User(EA.Repository Repository, string Package_GUID, string StereoType, Requirement_Plugin.Database Data)
        {
            ...
            string update = sQL_Command.Get_Update_Command("t_object", m_input_property, m_input_value, m_select_property, m_select_value, Data.metamodel.dB_Type);
