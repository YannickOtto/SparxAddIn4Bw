...
namespace Requirement_Plugin.Forms.Export
{
    public partial class Auswahl_Catalogue : Form
    {
        List<Repository_Elements.Catalogue> m_Catalogue = new List<Repository_Elements.Catalogue>();
        public List<Repository_Elements.Catalogue> m_ret = new List<Repository_Elements.Catalogue>();
        ...
        public Auswahl_Catalogue(List<Repository_Elements.Catalogue> m_catalogue)
        {
        ...
        private void Build_Anwendunsfall_Tree()
        {
            ...
            List<Repository_Elements.Catalogue> m_help = this.m_Catalogue.Where(x => x.m_Parent.Count == 0).ToList();
        ...
        private void button_Check_Click(object sender, EventArgs e)
        {
            ...
            if (this.check_bottom == true)
            {
                ...
                m_ret = new List<Repository_Elements.Catalogue>();
        ...
        private void treeView_Systemelemente_AfterCheck(object sender, TreeViewEventArgs e)
        {
            ...
            if (flag_bottom_check == false)
            {
                ...
                List<Repository_Elements.Catalogue> m_checked = new List<Repository_Elements.Catalogue>();
                List<Repository_Elements.Catalogue> m_To_Check = new List<Repository_Elements.Catalogue>();
                ...
                if (this.treeView_Anwendungsfall.Nodes.Count > 0)
                {
                    ...
                    do
                    {
                        ...
                        {
                            if (m_checked.Contains(this.treeView_Anwendungsfall.Nodes[i1].Tag as Repository_Elements.Catalogue) == false)
                            {
                                m_checked.Add(this.treeView_Anwendungsfall.Nodes[i1].Tag as Repository_Elements.Catalogue);
                            }
                        }

                        //Rekursiv erhalten
                        List<Repository_Elements.Catalogue> m_help =  Get_rekrusiv(this.treeView_Anwendungsfall.Nodes[i1]);
                    ...
                    if (m_checked.Count > 0)
                    {
                        ...
                        do
                        {
                            ...
                            List<Repository_Elements.Catalogue> m_Speciefied = null;// m_checked[i2].Get_All_SpecifiedBy(this.m_Catalogue);
                    ...
                    do
                    {
                        if (m_To_Check.Contains(this.treeView_Anwendungsfall.Nodes[i4].Tag as Repository_Elements.Catalogue) == true)
                        {
        ...
        private bool Einfaerben_rekursiv(TreeNode node, List<Repository_Elements.Catalogue> m_To_Check)
        {
            ...
            if (node.Nodes.Count > 0)
            {
                ...
                do
                {
                    if (m_To_Check.Contains(node.Nodes[i1].Tag as Repository_Elements.Catalogue) == true)
                    {
        ...
        private List<Repository_Elements.Catalogue> Get_rekrusiv(TreeNode node)
        {
            List<Repository_Elements.Catalogue> m_ret2 = new List<Repository_Elements.Catalogue>();
            ...
            if (node.Nodes.Count > 0)
            {
                ...
                do
                {
                    ...
                    {
                        if (m_ret2.Contains(node.Nodes[i1].Tag as Repository_Elements.Catalogue) == false)
                        {
                            m_ret2.Add(node.Nodes[i1].Tag as Repository_Elements.Catalogue);
                        }
                    }

                    List<Repository_Elements.Catalogue> m_help = Get_rekrusiv(node.Nodes[i1]);
        ...
        private void button_cancel_Click_1(object sender, EventArgs e)
        {
            ...
            this.m_ret = new List<Repository_Elements.Catalogue>();
        }
